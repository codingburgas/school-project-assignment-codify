...
void mainMenu()
{
	...
	EndDrawing();
	if (CheckCollisionRecs({ 1920.0f / 2.43f, 490, 370,80 }, mousePos) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) menuState = 1;
	if (CheckCollisionRecs({ 1920.0f / 2.43f, 610, 370,80 }, mousePos) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) menuState = 2; 
}